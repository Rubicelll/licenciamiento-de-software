create database licencias;
  ...
  --PRODUCTOS-- relacion de productos con categorias
  ...
  --PRODUCTOS-- disponibilidad del producto
  ...
  --LICENCIAS-- disponibilidad de licencias
  ...
  --REALACION DE PRODUCTOS CON LICENCIAS--
